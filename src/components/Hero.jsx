      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          ...
          <motion.h1
            ref={nameRef}
            variants={staggerChildren}
            className="hero-name text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-2 text-gradient leading-tight px-2 sm:px-0"
          >
            {profile.name}
          </motion.h1>
          ...
          <motion.p
            ref={titleRef}
            variants={staggerChildren}
            className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light mb-4 text-muted-foreground px-2 sm:px-0"
          >
            {profile.title}
          </motion.p>
          ...
          <motion.p
            variants={staggerChildren}
            className="text-base sm:text-lg max-w-3xl mx-auto mb-6 text-muted-foreground leading-relaxed px-4 sm:px-0"
          >
            {profile.summary}
          </motion.p>
          ...
          <motion.div
            variants={staggerChildren}
            className="flex flex-col sm:flex-row gap-3 justify-center mb-6 px-4 sm:px-0"
           >
            <motion.a
              href={whatsappUrl}
              target="_blank"
              ...
              whileTap={{ scale: 0.95 }}
              className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-3 animate-glow inline-flex items-center gap-2"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="btn-secondary text-base sm:text-lg px-6 sm:px-8 py-3"
            >
              View My Work
            </motion.button>
          </motion.div>
          ...
          <motion.div
            variants={staggerChildren}
            className="flex justify-center gap-4 mb-8 px-4 sm:px-0"
          >
            {[
          ...
          <motion.div
            ref={statsRef}
            variants={staggerChildren}
            className="grid grid-cols-2 lg:grid-cols-4 gap-4 px-4 sm:px-0"
          >
            {stats.map((stat, index) => (
              <motion.div
                key={stat.label}
                variants={staggerChildren}
                className="glass-card p-4 text-center group hover:bg-glass/60 transition-all duration-300"
              >
          ...
          <motion.div
            variants={staggerChildren}
            className="mt-8 glass-card p-4 mx-4 sm:mx-0"
          >
            <p className="text-muted-foreground mb-3 text-sm">Available for:</p>
