        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="relative w-full h-[90vh] sm:w-[85vw] sm:h-[80vh] md:w-[70vw] md:h-[70vh] lg:w-[50vw] lg:h-[50vh] bg-gradient-to-br from-slate-950/95 via-slate-900/90 to-slate-950/95 backdrop-blur-3xl rounded-3xl shadow-2xl border border-slate-700/50 pointer-events-auto flex flex-col"
              onClick={(e) => e.stopPropagation()}
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={onClose}
                className="absolute top-3 right-3 sm:top-4 sm:right-4 md:top-6 md:right-6 z-20 w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-full bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center text-white hover:text-blue-400 hover:border-blue-400/50 hover:bg-white/10 transition-all shadow-lg"
              >
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-5 md:p-6 lg:p-8 space-y-4 sm:space-y-5 md:space-y-6" style={{scrollbarWidth: 'thin', scrollbarColor: '#8b5cf6 transparent'}}>
                {/* Project Name - Title */}
                <motion.div
                ...
                >
                  <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl font-black leading-tight">
                ...
                {project.image && (
                  <motion.div
                    ...
                    className="relative h-32 sm:h-40 md:h-48 overflow-hidden rounded-xl"
                  >
                    <img
                      src={project.image.startsWith('/public') ? project.image.replace('/public', '') : project.image}
                      alt={project.name || project.title}
                ...
                {project.description && project.description !== project.subtitle && (
                  <motion.div
                    ...
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ delay: 0.3 }}
                    className="p-3 sm:p-4 md:p-6 bg-white/5 backdrop-blur-sm rounded-xl md:rounded-2xl border border-white/10"
                  >
                ...
                {(project.highlights || project.features) && (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2 sm:mb-3">
                      <div className="w-0.5 sm:w-1 h-4 sm:h-5 bg-gradient-to-b from-blue-500 to-purple-500 rounded-full" />
                    ...
                    <div className="grid gap-1.5 sm:gap-2">
                      {(project.highlights || project.features || []).slice(0, 3).map((highlight, index) => (
                        <motion.div
                          ...
                          className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-sm rounded-lg border border-white/10"
                        >
                          <div className="flex-shrink-0 w-5 h-5 sm:w-6 sm:h-6 rounded-md bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white text-xs font-bold">
                            {index + 1}
                          </div>
                ...
                {(project.stack || project.technologies) && (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2 sm:mb-3">
                      <div className="w-0.5 sm:w-1 h-4 sm:h-5 bg-gradient-to-b from-purple-500 to-blue-400 rounded-full" />
                      <h3 className="text-base sm:text-lg font-bold text-white">
                        Technologies
                      </h3>
                    </div>
                      ...
                      {(project.stack || project.technologies).map((tech, index) => {
                        ...
                        return (
                          <motion.span
                            ...
                            className="px-2 py-1 sm:px-3 sm:py-1.5 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-md sm:rounded-lg text-white font-semibold text-[10px] sm:text-xs border border-white/20 flex items-center gap-1 sm:gap-1.5"
                          >
                            {Icon && (
                              <Icon 
                ...
                <motion.div
                  ...
                  className="flex gap-2 sm:gap-3 pt-3 sm:pt-4 border-t border-white/10"
                >
                  {(project.liveLink || project.link) && (
                    <motion.a
                      href={project.liveLink || project.link}
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="flex-1 px-3 py-2 sm:px-4 sm:py-2.5 md:px-5 md:py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all flex items-center justify-center gap-1.5 sm:gap-2"
                    >
                  ...
                  {(project.githubUrl || project.github) && (
                    <motion.a
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex-1 px-3 py-2 sm:px-4 sm:py-2.5 md:px-5 md:py-3 bg-white/5 backdrop-blur-md border border-white/20 text-white rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm hover:border-purple-400/50 hover:bg-white/10 transition-all flex items-center justify-center gap-1.5 sm:gap-2"
                    >
